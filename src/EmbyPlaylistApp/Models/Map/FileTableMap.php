...
use EmbyPlaylistApp\Models\File;
use EmbyPlaylistApp\Models\FileQuery;
...
class FileTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EmbyPlaylistApp.Models.Map.FileTableMap';
     ...
     */
    const OM_CLASS = '\\EmbyPlaylistApp\\Models\\File';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EmbyPlaylistApp.Models.File';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Path', ),
        self::TYPE_CAMELNAME     => array('id', 'path', ),
        self::TYPE_COLNAME       => array(FileTableMap::COL_ID, FileTableMap::COL_PATH, ),
        self::TYPE_FIELDNAME     => array('id', 'path', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Path' => 1, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'path' => 1, ),
        self::TYPE_COLNAME       => array(FileTableMap::COL_ID => 0, FileTableMap::COL_PATH => 1, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'path' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EmbyPlaylistApp\\Models\\File');
        $this->setPackage('EmbyPlaylistApp.Models');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('path', 'Path', 'VARCHAR', true, 512, null);
    } // initialize()
    ...
    {
        $this->addRelation('ListXSong', '\\EmbyPlaylistApp\\Models\\ListFile', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':file_id',
    1 => ':id',
  ),
), null, null, 'ListXSongs', false);
        $this->addRelation('List', '\\EmbyPlaylistApp\\Models\\Playlist', RelationMap::MANY_TO_MANY, array(), null, null, 'Lists');
    } // buildRelations()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EmbyPlaylistApp\Models\File) { // it's a model object

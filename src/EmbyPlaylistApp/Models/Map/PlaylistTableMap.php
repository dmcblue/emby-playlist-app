...
/**
 * This class defines the structure of the 'list' table.
 *
 *
 *
...
class PlaylistTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'EmbyPlaylistApp.Models.Map.PlaylistTableMap';
     ...
     */
    const OM_CLASS = '\\EmbyPlaylistApp\\Models\\Playlist';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EmbyPlaylistApp.Models.Playlist';
     ...
     */
    const COL_ID = 'list.id';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'list.name';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(PlaylistTableMap::COL_ID, PlaylistTableMap::COL_NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(PlaylistTableMap::COL_ID => 0, PlaylistTableMap::COL_NAME => 1, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EmbyPlaylistApp\\Models\\Playlist');
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('File', '\\EmbyPlaylistApp\\Models\\File', RelationMap::MANY_TO_MANY, array(), null, null, 'Files');
    } // buildRelations()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \EmbyPlaylistApp\Models\Playlist) { // it's a model object
